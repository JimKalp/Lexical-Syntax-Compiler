...
declarations:          declarations type vars
                        ...
                        | declarations error fields T_ENDREC vars                                       {yyerror("wrong use of declarations" ); yyerrok;}
                        | declarations T_RECORD fields  error vars                                      {yyerror("wrong use of declarations" ); yyerrok;}
                        | declarations T_DATA vals
                        | declarations error vals                                                       {yyerror("wrong use of declarations" ); yyerrok;}
                        | %empty                                                                          { }
                        ;
type:                  T_INTEGER 
                        | T_REAL 
...
field:                 type vars
                        ...
                        |  error fields T_ENDREC vars                                                   {yyerror("wrong use of field" ); yyerrok;}    
                        | T_RECORD fields error vars                                                    {yyerror("wrong use of field" ); yyerrok;}
                        ;
...
assignment:            variable T_ASSIGN expression
                        ...
                        | variable error T_SCONST                                                                       { yyerror("Wrong use assigment"); yyerrok; }
                        | variable T_ASSIGN error                                                                       { yyerror("Wrong use of assigment"); yyerrok; }
                        ;
...
tail:                  T_ELSE body T_ENDIF                                                                         {scope++;}
                        ...
                        ;
loop_statement:        T_DO T_ID T_ASSIGN iter_space body T_ENDDO                                                  {scope++;  }                     
                        ;
